...
export const Avatar = React.memo((props: Props) => {
  const {size} = props;
  const size_ = PixelRatio.getPixelSizeForLayoutSize(size);
...
// `;
  ...
  // return <></>;
  // return <SvgXml xml={svgString} width={size_} height={size_} />;

  // return <SvgXml xml={svgString} />;
  return (<SvgXml xml={svgString} width="100%" height="100%" />); // see https://github.com/software-mansion/react-native-svg/blob/main/USAGE.md#use-with-xml-strings

  // return (
  //   <View style={{width: 132, height: 140}}>
